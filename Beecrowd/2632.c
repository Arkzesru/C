...
int main()
{
	...
	for (int i = 1; i <= T; i++)
	{
		...
		{
		case 1:
			radius = (strcmp(spellIdentifier, "fire") == 0) ? 20 : (strcmp(spellIdentifier, "water") == 0) ? 10
															   : (strcmp(spellIdentifier, "earth") == 0)   ? 25
															   : (strcmp(spellIdentifier, "air") == 0)	   ? 18
																										   : 0;
			break;
		case 2:
			radius = (strcmp(spellIdentifier, "fire") == 0) ? 30 : (strcmp(spellIdentifier, "water") == 0) ? 25
															   : (strcmp(spellIdentifier, "earth") == 0)   ? 55
															   : (strcmp(spellIdentifier, "air") == 0)	   ? 38
																										   : 0;
			break;
		case 3:
			radius = (strcmp(spellIdentifier, "fire") == 0) ? 50 : (strcmp(spellIdentifier, "water") == 0) ? 40
															   : (strcmp(spellIdentifier, "earth") == 0)   ? 70
															   : (strcmp(spellIdentifier, "air") == 0)	   ? 60
																										   : 0;
			break;
		default:
			radius = 0;
